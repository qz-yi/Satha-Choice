...
import { apiRequest, queryClient } from "@/lib/queryClient"; // أضفنا queryClient لتحديث البيانات فوراً
...
export default function DriverSignup() {
  ...
  async function onSubmit(data: any) {
    ...
    try {
      ...
      // ✅ تحديث الكاش لكي تظهر البيانات فوراً في لوحة المدير عند فتحها
      ...
      // ✅ الحل الجذري للمشكلة الأولى: التوجيه لصفحة السائق وليس الرئيسية
      // صفحة الـ DriverDashboard مبرمجة لتعرض "قيد الانتظار" إذا كان الحساب pending
      setLocation("/driver"); 
      ...
      toast({
        ...
        description: "يرجى التأكد من البيانات أو المحاولة لاحقاً.",
      });
    } finally {
    ...
    <div className="min-h-screen bg-[#F3F4F6] flex flex-col items-center p-6 font-sans" dir="rtl">
      ...
      >
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-black text-slate-900">انضم إلينا كـ سائق</h1>
          <p className="text-gray-500 font-bold">أدخل بياناتك لإنشاء ملفك الشخصي</p>
        </div>

        <Card className="border-none shadow-2xl rounded-[35px] overflow-hidden bg-white">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold flex items-center gap-2"><User className="w-4 h-4 text-orange-500"/> الاسم الكامل</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="مثال: بغداد، البصرة..." {...field} className="rounded-2xl border-slate-100 h-12 bg-slate-50 font-bold" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="رقم السيارة (مثال: 12345 بغداد)" {...field} className="rounded-2xl border-slate-100 h-12 bg-slate-50 font-bold" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <Button 
                  ...
                  className="w-full bg-slate-900 hover:bg-black text-white rounded-2xl h-14 text-lg font-black transition-all shadow-lg shadow-slate-900/20"
                >
